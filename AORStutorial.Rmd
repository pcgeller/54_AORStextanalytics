...
Some gotchas from thh files - *AMSAA - Extra first form.  Extra last form.  Scanned files cause transcription errors (extra spaces, inexact spelling).*
...
**Exercise - ** Extract another data field from the .pdfs.
...
[MAJ Larabee's DSCOE work](https://dscoe.army.mil) - Not a direct link, goes to DSCOE but a quick search will turn up his work.
